...
Bits, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Gauge32, Counter64, MibIdentifier, Counter32, Integer32, IpAddress, TimeTicks, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "Integer32", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32")
DisplayString, TruthValue, TimeStamp, TestAndIncr, PhysAddress, RowStatus, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "TestAndIncr", "PhysAddress", "RowStatus", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifOutErrors=ifOutErrors, ifType=ifType, ifHighSpeed=ifHighSpeed, ifStackLastChange=ifStackLastChange, ifConformance=ifConformance, ifTestGroup=ifTestGroup, ifInOctets=ifInOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInErrors=ifInErrors, interfaces=interfaces, ifTestCode=ifTestCode, ifNumber=ifNumber, ifOperStatus=ifOperStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifFixedLengthGroup=ifFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, InterfaceIndex=InterfaceIndex, ifLastChange=ifLastChange, ifInUcastPkts=ifInUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance=ifCompliance, ifRcvAddressType=ifRcvAddressType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestStatus=ifTestStatus, ifXEntry=ifXEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance2=ifCompliance2, linkDown=linkDown, ifTestOwner=ifTestOwner, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance3=ifCompliance3, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliances=ifCompliances, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackTable=ifStackTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifPacketGroup=ifPacketGroup, ifPhysAddress=ifPhysAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, ifDescr=ifDescr, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifTable=ifTable, ifTestEntry=ifTestEntry, ifOutUcastPkts=ifOutUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup=ifStackGroup, ifInDiscards=ifInDiscards, ifStackHigherLayer=ifStackHigherLayer, ifTestType=ifTestType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifStackGroup2=ifStackGroup2, ifName=ifName, ifHCInOctets=ifHCInOctets, PYSNMP_MODULE_ID=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifSpecific=ifSpecific, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifOutQLen=ifOutQLen, ifOutDiscards=ifOutDiscards, ifTestId=ifTestId, ifAlias=ifAlias, ifTestResult=ifTestResult, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackEntry=ifStackEntry, ifIndex=ifIndex, ifSpeed=ifSpeed, ifGeneralGroup=ifGeneralGroup, ifTableLastChange=ifTableLastChange, ifOutOctets=ifOutOctets, ifMtu=ifMtu, ifMIBObjects=ifMIBObjects, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLowerLayer=ifStackLowerLayer, ifMIB=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, linkUp=linkUp, ifAdminStatus=ifAdminStatus, ifTestTable=ifTestTable, ifConnectorPresent=ifConnectorPresent, ifGroups=ifGroups)
