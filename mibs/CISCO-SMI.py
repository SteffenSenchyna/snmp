...
# ASN.1 source file://mibs/CISCO-SMI.mib
...
TimeTicks, ModuleIdentity, Gauge32, enterprises, Counter64, Bits, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, IpAddress, Unsigned32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Gauge32", "enterprises", "Counter64", "Bits", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "IpAddress", "Unsigned32", "Integer32", "iso")
...
mibBuilder.exportSymbols("CISCO-SMI", cisco2516RptrGroup=cisco2516RptrGroup, ciscoPKI=ciscoPKI, ciscoLDAP=ciscoLDAP, cisco2505RptrGroup=cisco2505RptrGroup, ciscoTDomainDdp=ciscoTDomainDdp, ciscoCibProvGroup=ciscoCibProvGroup, ciscoMgmt=ciscoMgmt, ciscoSB=ciscoSB, ciscoTDomainSctpIpv6=ciscoTDomainSctpIpv6, ciscoChipSets=ciscoChipSets, ciscoCIB=ciscoCIB, ciscoTDomainClns=ciscoTDomainClns, ciscoAdmin=ciscoAdmin, ciscoContextProxy=ciscoContextProxy, workgroup=workgroup, ciscoAgentCapability=ciscoAgentCapability, ciscoProxy=ciscoProxy, ciscoTDomainTcpIpv4=ciscoTDomainTcpIpv4, local=local, pakmon=pakmon, ciscoPIB=ciscoPIB, ciscoWsx5020RptrGroup=ciscoWsx5020RptrGroup, ciscoChipSetSaint3=ciscoChipSetSaint3, ciscoTDomainIpx=ciscoTDomainIpx, ciscoPartyProxy=ciscoPartyProxy, cisco=cisco, otherEnterprises=otherEnterprises, ciscoCibMmiGroup=ciscoCibMmiGroup, ciscoChipSetSaint2=ciscoChipSetSaint2, ciscoTDomainUdpIpv4=ciscoTDomainUdpIpv4, newport=newport, ciscoTDomainLocal=ciscoTDomainLocal, ciscoTDomains=ciscoTDomains, ciscoDomains=ciscoDomains, ciscoSMB=ciscoSMB, ciscoPartnerProducts=ciscoPartnerProducts, ciscoPibToMib=ciscoPibToMib, ciscoTDomainSctpIpv4=ciscoTDomainSctpIpv4, lightstream=lightstream, PYSNMP_MODULE_ID=cisco, ciscoConfig=ciscoConfig, ciscoPolicyAuto=ciscoPolicyAuto, cisco2507RptrGroup=cisco2507RptrGroup, ciscoModules=ciscoModules, ciscoChipSetSaint4=ciscoChipSetSaint4, ciscoTDomainCons=ciscoTDomainCons, ciscoTDomainTcpIpv6=ciscoTDomainTcpIpv6, ciscoworks=ciscoworks, ciscoPolicy=ciscoPolicy, ciscoTDomainUdpIpv6=ciscoTDomainUdpIpv6, ciscoExperiment=ciscoExperiment, ciscoProducts=ciscoProducts, ciscoUnknownRptrGroup=ciscoUnknownRptrGroup, ciscoChipSetSaint1=ciscoChipSetSaint1, temporary=temporary, ciscoRptrGroupObjectID=ciscoRptrGroupObjectID)
