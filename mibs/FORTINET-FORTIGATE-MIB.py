...
FnIndex, fnSysSerial, fnAdminEntry, FnBoolState, fortinet = mibBuilder.importSymbols("FORTINET-CORE-MIB", "FnIndex", "fnSysSerial", "fnAdminEntry", "FnBoolState", "fortinet")
CounterBasedGauge64, = mibBuilder.importSymbols("HCNUM-TC", "CounterBasedGauge64")
ifIndex, ifEntry, ifName = mibBuilder.importSymbols("IF-MIB", "ifIndex", "ifEntry", "ifName")
...
Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Gauge32, ModuleIdentity, MibIdentifier, Counter32, Integer32, IpAddress, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Gauge32", "ModuleIdentity", "MibIdentifier", "Counter32", "Integer32", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32")
...
fgNPUGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 12356, 101, 100, 40)).setObjects(("FORTINET-FORTIGATE-MIB", "fgNPUNumber"), ("FORTINET-FORTIGATE-MIB", "fgNPUName"), ("FORTINET-FORTIGATE-MIB", "fgNPUDrvDriftSum"), ("FORTINET-FORTIGATE-MIB", "fgNPUSessionTblSize"), ("FORTINET-FORTIGATE-MIB", "fgNPUSessionCount"), ("FORTINET-FORTIGATE-MIB", "fgNPUDrvDrift"))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
...
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgSIAdvMemCacheInactive=fgSIAdvMemCacheInactive, fgVpnTunEntSelectorSrcBeginIp=fgVpnTunEntSelectorSrcBeginIp, fgVpnTunEntLifeBytes=fgVpnTunEntLifeBytes, fgIntfVlanHbs=fgIntfVlanHbs, fgWanOptWanInTraffic=fgWanOptWanInTraffic, fgt140D=fgt140D, fgIpSessFromPort=fgIpSessFromPort, fgt1000C=fgt1000C, fgProcessorContainedIn=fgProcessorContainedIn, fgTrapHaMemberDown=fgTrapHaMemberDown, fgObsoleteAppServicesObjectGroup=fgObsoleteAppServicesObjectGroup, fgUsbportPlugged=fgUsbportPlugged, fgIpsTrapObjects=fgIpsTrapObjects, fgWcStaBandwidthTx=fgWcStaBandwidthTx, fgApPOP3MaxConnections=fgApPOP3MaxConnections, fgInetProtoInfo=fgInetProtoInfo, fgSysMemCapacity=fgSysMemCapacity, fgExplicitProxyArchNest=fgExplicitProxyArchNest, fgExplicitProxyArchBomb=fgExplicitProxyArchBomb, fgVdEntSesCount=fgVdEntSesCount, fgLinkMonitorGroup=fgLinkMonitorGroup, fgHwSensorEntValue=fgHwSensorEntValue, fgExplicitProxyUsers=fgExplicitProxyUsers, fgIpsTrapSrcIp=fgIpsTrapSrcIp, fgApSMTPStatsEntry=fgApSMTPStatsEntry, fgIpSessStatsEntry=fgIpSessStatsEntry, fgAppP2PProtEntProto=fgAppP2PProtEntProto, fgVdEnabled=fgVdEnabled, fgProcModOther=fgProcModOther, fgProcessorEntIndex=fgProcessorEntIndex, fgProcModType=fgProcModType, fgTrapWcApDown=fgTrapWcApDown, fgApSIPStatsTable=fgApSIPStatsTable, fgWcApName=fgWcApName, fgIpsCritSevDetections=fgIpsCritSevDetections, fgt92D=fgt92D, fgt5001D=fgt5001D, FgHaStatsSyncStatusType=FgHaStatsSyncStatusType, fgVdTpMgmtAddr=fgVdTpMgmtAddr, fgAdminTable=fgAdminTable, fgApNNTPUpTime=fgApNNTPUpTime, fgVpnTunEntSelectorSrcPort=fgVpnTunEntSelectorSrcPort, fgWanOptTrafficStatsEntry=fgWanOptTrafficStatsEntry, fgProcessorPktDroppedCount=fgProcessorPktDroppedCount, fgIntfObjectGroup=fgIntfObjectGroup, fgVpnDialupTable=fgVpnDialupTable, fgVdNumber=fgVdNumber, fgHaStatsByteCount=fgHaStatsByteCount, fgSysSes6Rate60=fgSysSes6Rate60, fgApplications=fgApplications, fgIpsTrapSigMsg=fgIpsTrapSigMsg, fgVpnSslTunnelIp=fgVpnSslTunnelIp, fgWebCacheDiskMisses=fgWebCacheDiskMisses, fgTrapHaMemberUp=fgTrapHaMemberUp, fgt90D=fgt90D, fgAvIMAPVirusBlocked=fgAvIMAPVirusBlocked, fgHwSensors=fgHwSensors, fgProcessorEntry=fgProcessorEntry, fgWfHTTPURLBlocked=fgWfHTTPURLBlocked, fgWcWtpSessionWtpIpAddress=fgWcWtpSessionWtpIpAddress, fgWcWtpSessionVapWtpId=fgWcWtpSessionVapWtpId, fgVpnSslStatsLoginUsers=fgVpnSslStatsLoginUsers, FgWcWtpRadioBandType=FgWcWtpRadioBandType, fgWcStaEntry=fgWcStaEntry, fgWcStaIpAddressType=fgWcStaIpAddressType, fgAppIMFileTransfered=fgAppIMFileTransfered, fg300MibCompliance=fg300MibCompliance, fgProcessorFnNP6=fgProcessorFnNP6, fgWcWtpConfigVaps=fgWcWtpConfigVaps, fgVpnTunEntLocGwyPort=fgVpnTunEntLocGwyPort, fgVdTables=fgVdTables, fgWcWlanSsid=fgWcWlanSsid, fgt98DPOE=fgt98DPOE, fgAppProxyIM=fgAppProxyIM, fgVpnSslStatsActiveTunnels=fgVpnSslStatsActiveTunnels, fgWcWtpProfileRadioTable=fgWcWtpProfileRadioTable, fgWcWtpConfigWtpName=fgWcWtpConfigWtpName, fgVpnTunEntSelectorSrcEndIp=fgVpnTunEntSelectorSrcEndIp, fgAdminObjectGroup=fgAdminObjectGroup, fgProcessorFnNP2=fgProcessorFnNP2, fgFmTrapPrefix=fgFmTrapPrefix, fgWcWtpConfigWtpLocation=fgWcWtpConfigWtpLocation, fgUsbModemInfoObjects=fgUsbModemInfoObjects, fgWcWtpConfigWtpAdmin=fgWcWtpConfigWtpAdmin, fgApPOP3MemUsage=fgApPOP3MemUsage, fgWanOptTrafficStatsTable=fgWanOptTrafficStatsTable, fgWcStaBandwidthRx=fgWcStaBandwidthRx, fgApSIPOtherReq=fgApSIPOtherReq, fgAppScanUnit=fgAppScanUnit, fgWanOptDiskUsage=fgWanOptDiskUsage, fgWebfilter=fgWebfilter, fgWcWtpProfileRadioAutoTxPowerControl=fgWcWtpProfileRadioAutoTxPowerControl, fgApFTPMaxConnections=fgApFTPMaxConnections, fgWcWlanBroadcastSsid=fgWcWlanBroadcastSsid, fgWcWtpSessionWtpId=fgWcWtpSessionWtpId, fgt200DP=fgt200DP, fgVpnTunEntPhase2Name=fgVpnTunEntPhase2Name, fgWebCacheRAMLimit=fgWebCacheRAMLimit, fgWcStaWtpId=fgWcStaWtpId, fgProcessorTypes=fgProcessorTypes, fgFgWfHTTPOverridden=fgFgWfHTTPOverridden, fgFgWfHTTPSAllowed=fgFgWfHTTPSAllowed, fgIpSessTable=fgIpSessTable, fgWcWtpSessionWtpMemoryUsage=fgWcWtpSessionWtpMemoryUsage, fwf80CM=fwf80CM, fgSysLowMemUsage=fgSysLowMemUsage, fgFwPol6StatsTable=fgFwPol6StatsTable, fgSystem=fgSystem, fgAppSuStatsEntry=fgAppSuStatsEntry, fgWcWtpConfigEntry=fgWcWtpConfigEntry, fgHaStatsIndex=fgHaStatsIndex, fgTrapAvOversizeBlock=fgTrapAvOversizeBlock, fgNPUTable=fgNPUTable, fgAdminLcdProtection=fgAdminLcdProtection, fgWcWtpProfileRadioDarrp=fgWcWtpProfileRadioDarrp, FgAdminPermLevel=FgAdminPermLevel, fgSysCpuUsage=fgSysCpuUsage, fgApFTPStatsEntry=fgApFTPStatsEntry, fgHaStatsSyncStatus=fgHaStatsSyncStatus, FgVdIndex=FgVdIndex, FgHaLBSchedule=FgHaLBSchedule, FgWcWtpRadioMode=FgWcWtpRadioMode, fgWcWtpConfigRadioAutoTxPowerControl=fgWcWtpConfigRadioAutoTxPowerControl, FgNPUIndex=FgNPUIndex, fgWcWtpConfigRadioAutoTxPowerLow=fgWcWtpConfigRadioAutoTxPowerLow, fgIpsTables=fgIpsTables, fgLinkMonitorID=fgLinkMonitorID, FgWcWtpRadioId=FgWcWtpRadioId, fgHaStatsTable=fgHaStatsTable, fgIpsStatsEntry=fgIpsStatsEntry, fgtVM64SVM=fgtVM64SVM, fgWcWlanAuthentication=fgWcWlanAuthentication, fgAppIM=fgAppIM, fgUsbModemInfo=fgUsbModemInfo, fgLinkMonitorTable=fgLinkMonitorTable, fgTrapWcApUp=fgTrapWcApUp, fgtVM64VMX=fgtVM64VMX, FgWcWtpRadioChannelNumber=FgWcWtpRadioChannelNumber, fgLinkMonitorPacketRecv=fgLinkMonitorPacketRecv, fgWcWtpSessionRadioRadioId=fgWcWtpSessionRadioRadioId, fgSystemInfoAdvanced=fgSystemInfoAdvanced, fgHwSensorEntIndex=fgHwSensorEntIndex, fgExplicitProxyFilterStatsTable=fgExplicitProxyFilterStatsTable, fgProcessorIntel=fgProcessorIntel, fgAppIMMessages=fgAppIMMessages, fgVpnTunEntLocGwyIp=fgVpnTunEntLocGwyIp, fgTrapAvOversize=fgTrapAvOversize, fgWcWlanStationCount=fgWcWlanStationCount, fgWcWtpConfigRadioTxPowerLevel=fgWcWtpConfigRadioTxPowerLevel, fgVpnSslStatsTable=fgVpnSslStatsTable, fgAvHTTPVirusBlocked=fgAvHTTPVirusBlocked, fgVirtualDomainObjectGroup=fgVirtualDomainObjectGroup, fgWcWtpProfileTable=fgWcWtpProfileTable, fgWcStaSecurity=fgWcStaSecurity, fgSysLowMemCapacity=fgSysLowMemCapacity, fgFwUserInfo=fgFwUserInfo, fgIp6SessNumber=fgIp6SessNumber, fgWcWtpProfileRadioChannelBonding=fgWcWtpProfileRadioChannelBonding, fgHaStatsMemUsage=fgHaStatsMemUsage, fgSIAdvSesEphemeralLimit=fgSIAdvSesEphemeralLimit, fgLinkMonitorPacketLoss=fgLinkMonitorPacketLoss, fgt70D=fgt70D, fgIpSessToPort=fgIpSessToPort, fgVpnDialupOutOctets=fgVpnDialupOutOctets, fgSIAdvSesNoListenerCount=fgSIAdvSesNoListenerCount, fgFgWfHTTPAllowed=fgFgWfHTTPAllowed, fgAvFTPVirusDetected=fgAvFTPVirusDetected, fgIpsHighSevDetections=fgIpsHighSevDetections, fgSysDiskUsage=fgSysDiskUsage, fgExplicitProxyUpTime=fgExplicitProxyUpTime, fgUsbModemInfoGroup=fgUsbModemInfoGroup, fgVpnTunEntPhase1Name=fgVpnTunEntPhase1Name, fgWebCacheUpTime=fgWebCacheUpTime, fgProcModFnXG2=fgProcModFnXG2, fgUsbModemSignalStrength=fgUsbModemSignalStrength, fgWcStaGroup=fgWcStaGroup, fgt1200D=fgt1200D, fgExplicitProxyOversized=fgExplicitProxyOversized, fgAppExplicitProxy=fgAppExplicitProxy, fgFcSwSerial=fgFcSwSerial, fgTrapServerLoadBalanceRealServerDown=fgTrapServerLoadBalanceRealServerDown, fgAdmin=fgAdmin, fgIntfVlanHbCount=fgIntfVlanHbCount, fgFgWfHTTPSBlocked=fgFgWfHTTPSBlocked, fgProcessorPktTxCount=fgProcessorPktTxCount, fgSIAdvMemEnterProxyConsThrsh=fgSIAdvMemEnterProxyConsThrsh, fgIntfVrrpEntState=fgIntfVrrpEntState, fgApPOP3UpTime=fgApPOP3UpTime, fgFcObjectGroup=fgFcObjectGroup, fgWcWtpSessionVapEntry=fgWcWtpSessionVapEntry, fgUsbports=fgUsbports, FgFwUserAuthType=FgFwUserAuthType, FgWcWlanAuthenticationType=FgWcWlanAuthenticationType, fgExplicitProxyBlockedDLP=fgExplicitProxyBlockedDLP, fgVdMaxVdoms=fgVdMaxVdoms, fgHwSensorEntry=fgHwSensorEntry, fgFwUserTable=fgFwUserTable, fgWcWtpSessionRadioOperatingChannel=fgWcWtpSessionRadioOperatingChannel, fgProcessorUsage5sec=fgProcessorUsage5sec, fgApNNTPConnections=fgApNNTPConnections, fgFcTrapObjects=fgFcTrapObjects, fgApIMAPStatsEntry=fgApIMAPStatsEntry, fgProcModSACount=fgProcModSACount, fgApSIPCallHandling=fgApSIPCallHandling, fgIpSessIndex=fgIpSessIndex, fgIntfEntry=fgIntfEntry, fgWebCacheDiskLimit=fgWebCacheDiskLimit, fgt30D=fgt30D, fgAvVirusDetected=fgAvVirusDetected, fgAppVoIPConn=fgAppVoIPConn, fgIntrusionPrevtObjectGroup=fgIntrusionPrevtObjectGroup, fgIntfVlanHbTable=fgIntfVlanHbTable, fgAvTrapVirName=fgAvTrapVirName, fgWcStaNoise=fgWcStaNoise, fgApFTPUpTime=fgApFTPUpTime, fgNPUTables=fgNPUTables, fgLinkMonitorLatency=fgLinkMonitorLatency, fgVdEntCpuUsage=fgVdEntCpuUsage, fgAdminIdleTimeout=fgAdminIdleTimeout, fgWcWtpSessionWtpBootVersion=fgWcWtpSessionWtpBootVersion, fwf50E=fwf50E, fgAppWebCache=fgAppWebCache, fgAvFTPVirusBlocked=fgAvFTPVirusBlocked, fgWcWtpSessionVapRadioId=fgWcWtpSessionVapRadioId, fgExplicitProxyFilteredJS=fgExplicitProxyFilteredJS, fgt80C=fgt80C, fgSysSes6Rate30=fgSysSes6Rate30, fgVpnDialupLifetime=fgVpnDialupLifetime, fgProcessorAMD=fgProcessorAMD, fgSIAdvSesEphemeralCount=fgSIAdvSesEphemeralCount, fgProcModDescr=fgProcModDescr, fgTrapIpsFailOpen=fgTrapIpsFailOpen, fgApIMStatsTable=fgApIMStatsTable, fgVpnSslTunnelSrcIp=fgVpnSslTunnelSrcIp, fgWcWtpSessionWtpMemoryCapacity=fgWcWtpSessionWtpMemoryCapacity, fgHwSensorsObjectGroup=fgHwSensorsObjectGroup, fgIpsInfoSevDetections=fgIpsInfoSevDetections, FgWcCountryString=FgWcCountryString, fgWebfilterInfo=fgWebfilterInfo, fgVpnInfo=fgVpnInfo, fgtVM64KVm=fgtVM64KVm, fwf90D=fwf90D, fgFwPolPktCount=fgFwPolPktCount, fgPerCpuHighDetails=fgPerCpuHighDetails, fgByteCacheRAMUsage=fgByteCacheRAMUsage, fgAppProxySIP=fgAppProxySIP, fgVpnTunEntSelectorDstPort=fgVpnTunEntSelectorDstPort, fgWcInfoLocation=fgWcInfoLocation, fwf30D=fwf30D, FgWcWtpChannelWidthType=FgWcWtpChannelWidthType, fgIpsTrapSigId=fgIpsTrapSigId, fgProcModFnC20=fgProcModFnC20, fgAdministrationObjectGroup=fgAdministrationObjectGroup, fgHaOverride=fgHaOverride)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgVdTpTable=fgVdTpTable, fgWcWtpProfileRadioAutoTxPowerLow=fgWcWtpProfileRadioAutoTxPowerLow, fgProcModFnXE2=fgProcModFnXE2, fgHaInfo=fgHaInfo, fgProcModIndex=fgProcModIndex, fgVpnSslTunnelEntry=fgVpnSslTunnelEntry, fgFgWfHTTPExamined=fgFgWfHTTPExamined, fgExplicitProxyMemUsage=fgExplicitProxyMemUsage, fgExplicitProxyBlockedConType=fgExplicitProxyBlockedConType, fgVpnDialupIndex=fgVpnDialupIndex, fgWcWtpConfigRadioAutoTxPowerHigh=fgWcWtpConfigRadioAutoTxPowerHigh, fgWcWtpSessionVapStationCount=fgWcWtpSessionVapStationCount, fgFcSwVdom=fgFcSwVdom, fgVdEntIndex=fgVdEntIndex, fgVdInfo=fgVdInfo, fgExplicitProxyAllowedURLs=fgExplicitProxyAllowedURLs, fgExplicitProxyInfo=fgExplicitProxyInfo, fgVpnDialupSrcBegin=fgVpnDialupSrcBegin, fgVpnDialupVdom=fgVpnDialupVdom, fgVpnTunEntOutOctets=fgVpnTunEntOutOctets, fgHaGroupId=fgHaGroupId, fgWcWtpConfigWtpId=fgWcWtpConfigWtpId, fgWanOptLanInTraffic=fgWanOptLanInTraffic, fgWfHTTPBlocked=fgWfHTTPBlocked, fgIpsIntrusionsBlocked=fgIpsIntrusionsBlocked, fgWcWtpProfileRadioApScan=fgWcWtpProfileRadioApScan, fgWfAppletBlocked=fgWfAppletBlocked, fgt30DPOE=fgt30DPOE, fgIpsSignatureDetections=fgIpsSignatureDetections, fgHaStatsHostname=fgHaStatsHostname, fgAdminTables=fgAdminTables, fgt400D=fgt400D, fgFgWfHTTPSLogged=fgFgWfHTTPSLogged, fgUsbportEntry=fgUsbportEntry, fgUsbportProduct=fgUsbportProduct, fgExplicitProxyFilteredVBS=fgExplicitProxyFilteredVBS, fgIpSessVdom=fgIpSessVdom, fgHaSystemMode=fgHaSystemMode, fgHighAvailabilityObjectGroup=fgHighAvailabilityObjectGroup, fgAppVoIPStatsEntry=fgAppVoIPStatsEntry, fgWcWtpProfileRadioMode=fgWcWtpProfileRadioMode, fgVpnSslStatsMaxUsers=fgVpnSslStatsMaxUsers, fgt51E=fgt51E, fgFwUserEntry=fgFwUserEntry, fgApIMAPSpamDetected=fgApIMAPSpamDetected, fgWcStaSignal=fgWcStaSignal, fgFmTrapObjectGroup=fgFmTrapObjectGroup, fgVdEntHaState=fgVdEntHaState, fgTrapAvVirus=fgTrapAvVirus, fgt90DPOE=fgt90DPOE, fgWcWtpSessionWtpByteTxCount=fgWcWtpSessionWtpByteTxCount, fgWcWtpSessionTable=fgWcWtpSessionTable, fgFwPolPktCountHc=fgFwPolPktCountHc, fgUsbModemNetwork=fgUsbModemNetwork, fgApIMAPMemUsage=fgApIMAPMemUsage, fgApIMStatsEntry=fgApIMStatsEntry, fgAppIMStatsTable=fgAppIMStatsTable, fgWebCacheInfo=fgWebCacheInfo, fgHaGroupName=fgHaGroupName, fgFmTrapIfChange=fgFmTrapIfChange, fgVpnTables=fgVpnTables, fgVpnTunEntTimeout=fgVpnTunEntTimeout, fgAvSMTPVirusBlocked=fgAvSMTPVirusBlocked, fgWanOptDisk=fgWanOptDisk, fgt94DPOE=fgt94DPOE, fgUsbModemStatus=fgUsbModemStatus, fgWebCacheRAMHits=fgWebCacheRAMHits, fgWcWtpSessionEntry=fgWcWtpSessionEntry, fgSIAdvSesExpCount=fgSIAdvSesExpCount, fgIpsAnomalyDetections=fgIpsAnomalyDetections, fgt500D=fgt500D, fgLinkMonitor=fgLinkMonitor, fgAvNNTPVirusBlocked=fgAvNNTPVirusBlocked, fgWebCacheRequests=fgWebCacheRequests, fgSysSes6Count=fgSysSes6Count, fgt70DPOE=fgt70DPOE, fgWcStaUser=fgWcStaUser, fgWcInfoName=fgWcInfoName, fgNPUDrvDrift=fgNPUDrvDrift, fgExplicitProxyArchCorrupt=fgExplicitProxyArchCorrupt, fgAvInfo=fgAvInfo, fgWcWtpSessionWtpRegionCode=fgWcWtpSessionWtpRegionCode, fgt80D=fgt80D, fgIntfVrrpTable=fgIntfVrrpTable, fgWcWtpProfileRadioDtimPeriod=fgWcWtpProfileRadioDtimPeriod, fgMemCacheMisses=fgMemCacheMisses, fgSIAdvMemEnterKerConsThrsh=fgSIAdvMemEnterKerConsThrsh, fgWcWtpProfileRadioTxPowerLevel=fgWcWtpProfileRadioTxPowerLevel, fgWcWtpSessionWtpSwVersion=fgWcWtpSessionWtpSwVersion, fgApNNTPReqProcessed=fgApNNTPReqProcessed, fgNPUSessionTblSize=fgNPUSessionTblSize, fgt100D=fgt100D, fgExplicitProxyBlockedURLs=fgExplicitProxyBlockedURLs, fgVpnSslTunnelUserName=fgVpnSslTunnelUserName, fgWanOptLANBytesIn=fgWanOptLANBytesIn, fgWcStaChannel=fgWcStaChannel, fgVpnObjectGroup=fgVpnObjectGroup, fgVpnTrapPhase1Name=fgVpnTrapPhase1Name, fgExplicitProxyStatsTable=fgExplicitProxyStatsTable, fgWcWtpSessionWtpSessionUpTime=fgWcWtpSessionWtpSessionUpTime, fgApHTTPMemUsage=fgApHTTPMemUsage, fgWcWtpProfileDataChannelDtlsPolicy=fgWcWtpProfileDataChannelDtlsPolicy, fgtVM64AWS=fgtVM64AWS, fgAppProxyFTP=fgAppProxyFTP, fgSysDiskCapacity=fgSysDiskCapacity, fgWanOptUpTime=fgWanOptUpTime, fgFortiGuardStatsTable=fgFortiGuardStatsTable, fgAvPOP3VirusDetected=fgAvPOP3VirusDetected, fgWcWtpSessionVapTable=fgWcWtpSessionVapTable, fgWanOptWANBytesOut=fgWanOptWANBytesOut, fgLinkMonitorPacketSend=fgLinkMonitorPacketSend, fgHwSensorEntAlarmStatus=fgHwSensorEntAlarmStatus, fgWanOptWanOutTraffic=fgWanOptWanOutTraffic, fgVpnSslStatsMaxTunnels=fgVpnSslStatsMaxTunnels, fgTrapFazDisconnect=fgTrapFazDisconnect, fgVpnSslTunnelUpTime=fgVpnSslTunnelUpTime, fgApSMTPUpTime=fgApSMTPUpTime, fgIpsStatsTable=fgIpsStatsTable, fgWcWtpConfigRadioBand=fgWcWtpConfigRadioBand, fgFwPolicies=fgFwPolicies, fgTrapIpsAnomaly=fgTrapIpsAnomaly, fgWcInfoWtpSessions=fgWcInfoWtpSessions, fgLinkMonitorVdom=fgLinkMonitorVdom, fgWebfilterTables=fgWebfilterTables, fgFc=fgFc, fgAppP2PStatsTable=fgAppP2PStatsTable, fgApSIPClientReg=fgApSIPClientReg, fgIpSessNumber=fgIpSessNumber, fgt140P=fgt140P, fgFwPolByteCount=fgFwPolByteCount, fgWfHTTPSBlocked=fgWfHTTPSBlocked, fgExplicitProxyArchEncrypted=fgExplicitProxyArchEncrypted, fgWcStaTable=fgWcStaTable, fgDeviceMacAddress=fgDeviceMacAddress, fgTrapFcSwUp=fgTrapFcSwUp, fgWanOptProtocol=fgWanOptProtocol, fgProcessorModuleTable=fgProcessorModuleTable, fgUsbModemSimId=fgUsbModemSimId, fgUsbportRevision=fgUsbportRevision, fgHaStatsGlobalChecksum=fgHaStatsGlobalChecksum, fgTrapAvPattern=fgTrapAvPattern, fgAppProxySMTP=fgAppProxySMTP, fgWanOptHistoryStatsEntry=fgWanOptHistoryStatsEntry, fgVpnTunEntStatus=fgVpnTunEntStatus, fgProcessorModuleEntry=fgProcessorModuleEntry, fgt30E=fgt30E, fgr60D=fgr60D, fgWcStaVci=fgWcStaVci, fgFcSwName=fgFcSwName, fgAppP2PProtoEntry=fgAppP2PProtoEntry, fgApSIPStatsEntry=fgApSIPStatsEntry, fgApPOP3SpamDetected=fgApPOP3SpamDetected, fgAppP2PConnBlocked=fgAppP2PConnBlocked, fgWcWtpSessionWtpUpTime=fgWcWtpSessionWtpUpTime, fgNPUGroup=fgNPUGroup, fgSysSes6Rate10=fgSysSes6Rate10, fgLinkMonitorEntry=fgLinkMonitorEntry, fgLinkMonitorName=fgLinkMonitorName, fgWebCacheDiskStatsTable=fgWebCacheDiskStatsTable, fgFwUserNumber=fgFwUserNumber, fgVpnTrapRemoteGateway=fgVpnTrapRemoteGateway, fgUsbModemId=fgUsbModemId, fgWc=fgWc, fgFgWfHTTPSExamined=fgFgWfHTTPSExamined, fgWcInfoWtpManaged=fgWcInfoWtpManaged, fgt3100D=fgt3100D, fgTrapFcSwDown=fgTrapFcSwDown, fgFwPol6ByteCount=fgFwPol6ByteCount, fgApSIPMemUsage=fgApSIPMemUsage, fgSysInfoAdvMem=fgSysInfoAdvMem, fgWfActiveXBlocked=fgWfActiveXBlocked, fgVpnTunEntRemGwyIp=fgVpnTunEntRemGwyIp, fgTrapVpnTunDown=fgTrapVpnTunDown, fgExplicitProxyLoggedURLs=fgExplicitProxyLoggedURLs, fgt60DPOE=fgt60DPOE, fgFirewall=fgFirewall, fgExplicitProxyArchUnsupported=fgExplicitProxyArchUnsupported, fgProcModFnFB4=fgProcModFnFB4, fgIntfVrrpEntIndex=fgIntfVrrpEntIndex, fosVM64KVM=fosVM64KVM, fgNPUSessionCount=fgNPUSessionCount, fgAdminVdom=fgAdminVdom, fgWanOptDiskStatsTable=fgWanOptDiskStatsTable, fgProcessorUsage=fgProcessorUsage, fgSysSesRate1=fgSysSesRate1, fgWcStaEncrypt=fgWcStaEncrypt, fgApIMAPConnections=fgApIMAPConnections, fgWebCacheRAMMisses=fgWebCacheRAMMisses, fgWanOptWanTraffic=fgWanOptWanTraffic, fgWcWtpConfigTable=fgWcWtpConfigTable, fgWanOptDiskLimit=fgWanOptDiskLimit, fgWcWtpSessionRadioMode=fgWcWtpSessionRadioMode, fgManIfMask=fgManIfMask, fgAvHTTPVirusDetected=fgAvHTTPVirusDetected, FgWcWlanSecurityType=FgWcWlanSecurityType, fgIpsIntrusionsDetected=fgIpsIntrusionsDetected, fgHaTrapMemberSerial=fgHaTrapMemberSerial, fgFwUserName=fgFwUserName, fgWcWtpProfileRadioChannel=fgWcWtpProfileRadioChannel, fgServerLoadBalanceTrapObjects=fgServerLoadBalanceTrapObjects, fgt3240C=fgt3240C, fgWcWtpSessionWtpHwVersion=fgWcWtpSessionWtpHwVersion, fgWebFilterObjectGroup=fgWebFilterObjectGroup, fgWcWtpSessionRadioBaseBssid=fgWcWtpSessionRadioBaseBssid, fgApPOP3StatsEntry=fgApPOP3StatsEntry, fgWcWlanUserGroup=fgWcWlanUserGroup, fgApHTTPMaxConnections=fgApHTTPMaxConnections, fgVdEntOpMode=fgVdEntOpMode, fgWcInfoStationCapacity=fgWcInfoStationCapacity, fgWcStaIdle=fgWcStaIdle, fgWcWlanStationCapacity=fgWcWlanStationCapacity, fgHaStatsIdsCount=fgHaStatsIdsCount, fgProcModFnF20=fgProcModFnF20, fgVpnSslStatsMaxWebSessions=fgVpnSslStatsMaxWebSessions, fgt80CM=fgt80CM, fgt800D=fgt800D, fgApIMAPUpTime=fgApIMAPUpTime, fgExplicitProxyFilterStatsEntry=fgExplicitProxyFilterStatsEntry, fgFwUserAuthTimeout=fgFwUserAuthTimeout, fgSoftware=fgSoftware, fgr90D=fgr90D, fgApNNTPMaxConnections=fgApNNTPMaxConnections, fgVpnDialupTimeout=fgVpnDialupTimeout, fgWcWtpProfileName=fgWcWtpProfileName, fgWcWtpSessionVapByteTxCount=fgWcWtpSessionVapByteTxCount, fgVdTpEntry=fgVdTpEntry, fgNPUName=fgNPUName, fgVdEntMemUsage=fgVdEntMemUsage, fgFwPolStatsEntry=fgFwPolStatsEntry, fgServerLoadBalanceRealServerAddress=fgServerLoadBalanceRealServerAddress, fgIntfVrrpEntIfName=fgIntfVrrpEntIfName, fgTrapIpsSignature=fgTrapIpsSignature, fgLinkMonitorState=fgLinkMonitorState, fgWcWtpProfileRadioWidsProfile=fgWcWtpProfileRadioWidsProfile, fgt3815D=fgt3815D, fgWcWlanMeshBackhaul=fgWcWlanMeshBackhaul, fgWcWtpSessionRadioCountryCode=fgWcWtpSessionRadioCountryCode, fgApNNTPMemUsage=fgApNNTPMemUsage, fgHwSensorCount=fgHwSensorCount, fgHaStatsSyncDatimeUnsucc=fgHaStatsSyncDatimeUnsucc, fgWcWtpProfileEntry=fgWcWtpProfileEntry, fgt3810D=fgt3810D, fgMemCacheLimit=fgMemCacheLimit, fgVpnTrapObjects=fgVpnTrapObjects, fgSIAdvMemBuffer=fgSIAdvMemBuffer, fgUsbModemProduct=fgUsbModemProduct, fgDevice=fgDevice, fgHaStatsPktCount=fgHaStatsPktCount, fgWcWtpSessionRadioWtpId=fgWcWtpSessionRadioWtpId, fgWanOptReductionRate=fgWanOptReductionRate, fgSysVersionIps=fgSysVersionIps, fgVpnTunEntIndex=fgVpnTunEntIndex, fgMgmtTrapObjects=fgMgmtTrapObjects, fgExplicitProxyStatsEntry=fgExplicitProxyStatsEntry)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgVpnTunEntSelectorDstEndIp=fgVpnTunEntSelectorDstEndIp, fgWcWlanLocalBridging=fgWcWlanLocalBridging, fgNPUEntIndex=fgNPUEntIndex, fgProcessorsTrapObjects=fgProcessorsTrapObjects, fgFwUserTables=fgFwUserTables, fgSysVersionAv=fgSysVersionAv, fgWcStaRadioType=fgWcStaRadioType, fgWebCacheDisk=fgWebCacheDisk, fgServerLoadBalanceVirtualServerName=fgServerLoadBalanceVirtualServerName, fgVdEntName=fgVdEntName, fgApFTPConnections=fgApFTPConnections, fgAppSuIndex=fgAppSuIndex, fgApPOP3ReqProcessed=fgApPOP3ReqProcessed, fgInetProtoTables=fgInetProtoTables, fgAppP2PProtEntBytes=fgAppP2PProtEntBytes, fgApSMTPStatsTable=fgApSMTPStatsTable, fgWcStaOnline=fgWcStaOnline, fgAppProxyNNTP=fgAppProxyNNTP, fgApSMTPMemUsage=fgApSMTPMemUsage, fwf90DPOE=fwf90DPOE, fgIpSessEntry=fgIpSessEntry, fgt5001C=fgt5001C, fgWanOptInfo=fgWanOptInfo, fgWcInfoStationCount=fgWcInfoStationCount, fgApSMTPReqProcessed=fgApSMTPReqProcessed, fgWcWtpSessionWtpByteRxCount=fgWcWtpSessionWtpByteRxCount, fwf30E=fwf30E, fgWcStaWlan=fgWcStaWlan, fgIntfTables=fgIntfTables, fgVpnTunEntry=fgVpnTunEntry, fgWfCookieBlocked=fgWfCookieBlocked, fgHaStatsEntry=fgHaStatsEntry, fgHaStatsSesCount=fgHaStatsSesCount, fgWcWtpProfileRadioEntry=fgWcWtpProfileRadioEntry, fgt600C=fgt600C, fgProcessors=fgProcessors, fgExplicitProxyScanStatsDisp=fgExplicitProxyScanStatsDisp, fgHwSensorEntName=fgHwSensorEntName, fgTrapVpnTunUp=fgTrapVpnTunUp, fgHighAvailability=fgHighAvailability, fgHaStatsAvCount=fgHaStatsAvCount, fgExplicitProxyScriptStatsTable=fgExplicitProxyScriptStatsTable, fgProcessorXlr=fgProcessorXlr, fgWcWtpSessionWtpModelNumber=fgWcWtpSessionWtpModelNumber, fgWanOptHistPeriod=fgWanOptHistPeriod, fgIpSessStatsTable=fgIpSessStatsTable, fgWcWlanVlanId=fgWcWlanVlanId, fgProcessorSysUsage=fgProcessorSysUsage, fgWcWtpConfigWtpProfile=fgWcWtpConfigWtpProfile, fgt1500D=fgt1500D, fgProcModFnCE4=fgProcModFnCE4, fgWcWtpSessionRadioCountryString=fgWcWtpSessionRadioCountryString, fgDeviceLastSeen=fgDeviceLastSeen, fgTrapAvBypass=fgTrapAvBypass, fgMgmt=fgMgmt, fgt1500DT=fgt1500DT, fgAvTables=fgAvTables, fgApHTTPStatsEntry=fgApHTTPStatsEntry, fgExplicitProxyFilteredApplets=fgExplicitProxyFilteredApplets, fgExplicitProxyFilteredJScript=fgExplicitProxyFilteredJScript, fgIpSessFromAddr=fgIpSessFromAddr, fgVpnSslStatsActiveWebSessions=fgVpnSslStatsActiveWebSessions, fgIntfVrrpEntVrIp=fgIntfVrrpEntVrIp, fgIntfVlanHbEntState=fgIntfVlanHbEntState, fgAvPOP3VirusBlocked=fgAvPOP3VirusBlocked, FgOpMode=FgOpMode, fgWebCacheDiskStatsEntry=fgWebCacheDiskStatsEntry, fgAppSuStatsTable=fgAppSuStatsTable, fgWanOptDiskHits=fgWanOptDiskHits, fgt280D=fgt280D, fgApHTTPUpTime=fgApHTTPUpTime, FgP2PProto=FgP2PProto, fgWanOptStatsTable=fgWanOptStatsTable, fgWcWtpSessionWtpStationCount=fgWcWtpSessionWtpStationCount, fgVdTpMgmtAddrType=fgVdTpMgmtAddrType, fgFwPolInfo=fgFwPolInfo, fgFgWfHTTPLogged=fgFgWfHTTPLogged, fgTrapHaHBFail=fgTrapHaHBFail, fgApIMAPReqProcessed=fgApIMAPReqProcessed, fgApNNTPStatsTable=fgApNNTPStatsTable, fgIntfVrrps=fgIntfVrrps, fgUsbportsObjectGroup=fgUsbportsObjectGroup, fgtVM64XEN=fgtVM64XEN, fgWcWlanSecurity=fgWcWlanSecurity, fgTrapAvEnterConserve=fgTrapAvEnterConserve, fgObsoleteNotificationsGroup=fgObsoleteNotificationsGroup, FgWanOptProtocols=FgWanOptProtocols, fgIpsInfo=fgIpsInfo, fgFwUsers=fgFwUsers, fgApSMTPMaxConnections=fgApSMTPMaxConnections, fgIp6SessStatsTable=fgIp6SessStatsTable, fgt240DP=fgt240DP, fgSysVersion=fgSysVersion, fgt3200D=fgt3200D, fgFwPolLastUsed=fgFwPolLastUsed, fgVpnSslTunnelBytesOut=fgVpnSslTunnelBytesOut, fgt3600C=fgt3600C, fgMibConformance=fgMibConformance, fgtVM64=fgtVM64, fgSysMemUsage=fgSysMemUsage, fgUsbportClass=fgUsbportClass, fgIp6SessStatsEntry=fgIp6SessStatsEntry, fgVpnTunTable=fgVpnTunTable, fgProcModFnFB8=fgProcModFnFB8, fgWanOptLanOutTraffic=fgWanOptLanOutTraffic, fgWcWtpProfileRadioFrequencyHandoff=fgWcWtpProfileRadioFrequencyHandoff, fw60DP=fw60DP, fgVpnTunEntInOctets=fgVpnTunEntInOctets, fgApPOP3Connections=fgApPOP3Connections, fgFwPol6PktCount=fgFwPol6PktCount, fgTrapHaSwitch=fgTrapHaSwitch, fgFgWfHTTPBlocked=fgFgWfHTTPBlocked, fosVM64=fosVM64, fgFmTrapGroup=fgFmTrapGroup, fgExplicitProxyRequests=fgExplicitProxyRequests, FgHaMode=FgHaMode, fgVpnSslTunnelBytesIn=fgVpnSslTunnelBytesIn, fnFortiGateMib=fnFortiGateMib, fgAppP2PProtoTable=fgAppP2PProtoTable, fgSysSesCount=fgSysSesCount, fgAntivirusObjectGroup=fgAntivirusObjectGroup, fgApFTPStatsTable=fgApFTPStatsTable, fgWcStaVlanId=fgWcStaVlanId, fgIntfEntVdom=fgIntfEntVdom, fgExplicitProxyOverriddenURLs=fgExplicitProxyOverriddenURLs, fgSIAdvMemCacheActive=fgSIAdvMemCacheActive, fgFwPolByteCountHc=fgFwPolByteCountHc, fgNPUEntry=fgNPUEntry, fgTraps=fgTraps, fgUsbportVersion=fgUsbportVersion, fgWcWtpSessionWtpIpAddressType=fgWcWtpSessionWtpIpAddressType, fgExplicitProxyFilteredActiveX=fgExplicitProxyFilteredActiveX, fgt60D=fgt60D, fgSIAdvSesAcceptQFCount=fgSIAdvSesAcceptQFCount, fgProcessorModuleCount=fgProcessorModuleCount, fgLinkMonitorJitter=fgLinkMonitorJitter, fgWanOptLanTraffic=fgWanOptLanTraffic, fgHaStatsCpuUsage=fgHaStatsCpuUsage, fgTrapAvFragmented=fgTrapAvFragmented, fgFortiGuardStatsEntry=fgFortiGuardStatsEntry, fgSystemObjectGroup=fgSystemObjectGroup, fgWanOptWANBytesIn=fgWanOptWANBytesIn, fgFwPol6StatsEntry=fgFwPol6StatsEntry, fgExplicitProxyScanStatsEntry=fgExplicitProxyScanStatsEntry, fgVdEntry=fgVdEntry, fgWebCacheDiskUsage=fgWebCacheDiskUsage, fgtVM64HV=fgtVM64HV, fgWcStaHost=fgWcStaHost, fgAvTrapObjects=fgAvTrapObjects, fgt240D=fgt240D, fgSysSesRate60=fgSysSesRate60, fgProcModIntegratedNPU=fgProcModIntegratedNPU, fgFwUserIndex=fgFwUserIndex, fgSoftwareObjectGroup=fgSoftwareObjectGroup, fwf60D=fwf60D, fgSIAdvMemLeaveProxyConsThrsh=fgSIAdvMemLeaveProxyConsThrsh, fgNPUDrvDriftSum=fgNPUDrvDriftSum, fgWcWlanTable=fgWcWlanTable, fgApPOP3StatsTable=fgApPOP3StatsTable, fgTrapAvOversizePass=fgTrapAvOversizePass, fgUsbportSerial=fgUsbportSerial, fgProcModFnXD2=fgProcModFnXD2, fgFwPol6LastUsed=fgFwPol6LastUsed, fgTrapIpsPkgUpdate=fgTrapIpsPkgUpdate, fgExplicitProxyScriptStatsEntry=fgExplicitProxyScriptStatsEntry, fgVpnDialupEntry=fgVpnDialupEntry, fgProcModFnXB2=fgProcModFnXB2, fgFwPolTables=fgFwPolTables, fwf30DPOE=fwf30DPOE, fgApHTTPConnections=fgApHTTPConnections, fgExplicitProxyVirus=fgExplicitProxyVirus, fgObsolteMIBCompliance=fgObsolteMIBCompliance, fgHaStatsSerial=fgHaStatsSerial, fgWcWtpSessionVapSsid=fgWcWtpSessionVapSsid, fgWebCacheRAMUsage=fgWebCacheRAMUsage, fgWcWtpSessionWtpProfileName=fgWcWtpSessionWtpProfileName, fgAppVoIPCallBlocked=fgAppVoIPCallBlocked, fgVpnSslTunnelVdom=fgVpnSslTunnelVdom, fgSysInfoAdvSessions=fgSysInfoAdvSessions, fgVpnTunnelUpCount=fgVpnTunnelUpCount, fgAppProxyHTTP=fgAppProxyHTTP, fgAppP2PProtoEntLastReset=fgAppP2PProtoEntLastReset, fgApFTPMemUsage=fgApFTPMemUsage, fgWcWtpProfileRadioApHandoff=fgWcWtpProfileRadioApHandoff, fgWcStaRadioId=fgWcStaRadioId, fgUsbportCount=fgUsbportCount, fgAppVoIPStatsTable=fgAppVoIPStatsTable, fgServerLoadBalance=fgServerLoadBalance, fgSIAdvSesSyncQFCount=fgSIAdvSesSyncQFCount, fgMemCacheHits=fgMemCacheHits, fgVpnTunEntRemGwyPort=fgVpnTunEntRemGwyPort, fgVpnSslStatsEntry=fgVpnSslStatsEntry, fgIntfInfo=fgIntfInfo, fgProcessorFnSoc=fgProcessorFnSoc, fgWebfilterStatsEntry=fgWebfilterStatsEntry, fgt3HD=fgt3HD, fgFmTrapDeployInProgress=fgFmTrapDeployInProgress, fgFwUserAuth=fgFwUserAuth, fgProcessorModules=fgProcessorModules, fgProcessorCount=fgProcessorCount, fgWcWtpSessionRadioTable=fgWcWtpSessionRadioTable, fgFwUserVdom=fgFwUserVdom, fgWcInfo=fgWcInfo, fgVdEntSesRate=fgVdEntSesRate, FgHaState=FgHaState, fgProcModMemCapacity=fgProcModMemCapacity, fgWfHTTPSURLBlocked=fgWfHTTPSURLBlocked, fgWanOptDiskStatsEntry=fgWanOptDiskStatsEntry, fgVdTpMgmtMask=fgVdTpMgmtMask, fgApIMAPMaxConnections=fgApIMAPMaxConnections, fgWanOptObjectGroup=fgWanOptObjectGroup, fgWcWtpSessionWtpDaemonUpTime=fgWcWtpSessionWtpDaemonUpTime, fgProcessorOther=fgProcessorOther, fgWcWtpProfileRadioRadioId=fgWcWtpProfileRadioRadioId, fgIntfVlanHbEntry=fgIntfVlanHbEntry, fgNotificationGroup=fgNotificationGroup, fgExplicitProxySessions=fgExplicitProxySessions, fgWanOptTunnels=fgWanOptTunnels, fgFwUserState=fgFwUserState, fgManIfIp6=fgManIfIp6, fgAvIMVirusBlocked=fgAvIMVirusBlocked, fgMIBCompliance=fgMIBCompliance, fgWcWtpConfigVapAll=fgWcWtpConfigVapAll, fgWcWtpSessionConnectionState=fgWcWtpSessionConnectionState, fgExplicitProxyArchSize=fgExplicitProxyArchSize, fgAntivirus=fgAntivirus, fgSIAdvSesClashCount=fgSIAdvSesClashCount, fgFirewallObjectGroup=fgFirewallObjectGroup, fgAppServicesObjectGroup=fgAppServicesObjectGroup, fgSysSesRate30=fgSysSesRate30, fgSIAdvMemLeaveKerConsThrsh=fgSIAdvMemLeaveKerConsThrsh, fgExplicitProxyArchMultiPart=fgExplicitProxyArchMultiPart, fgIntfVlanHbEntIfName=fgIntfVlanHbEntIfName, fgt1000D=fgt1000D, fgWcWlanEncryption=fgWcWlanEncryption, fgAvStatsTable=fgAvStatsTable, fgAvIMVirusDetected=fgAvIMVirusDetected, fgVpnSslTunnelTable=fgVpnSslTunnelTable, fgVpnTrapLocalGateway=fgVpnTrapLocalGateway, fgInetProto=fgInetProto, fgDeviceCreated=fgDeviceCreated, fgApNNTPStatsEntry=fgApNNTPStatsEntry, fgWcWtpProfileRadioStationCapacity=fgWcWtpProfileRadioStationCapacity, fgWcWtpSessionWtpCpuUsage=fgWcWtpSessionWtpCpuUsage, fgProcModName=fgProcModName, fgAdminOptions=fgAdminOptions, fgExplicitProxyExaminedURLs=fgExplicitProxyExaminedURLs, fgHaStatsSyncDatimeSucc=fgHaStatsSyncDatimeSucc, fgAppProxyIMAP=fgAppProxyIMAP, fgApFTPReqProcessed=fgApFTPReqProcessed, fgSysUpTime=fgSysUpTime, fgVirtualDomain=fgVirtualDomain, fgHwSensorTable=fgHwSensorTable, fgProcessorUserUsage=fgProcessorUserUsage)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgExplicitProxyBannedWords=fgExplicitProxyBannedWords, fgVpnTunEntSelectorProto=fgVpnTunEntSelectorProto, fgWcWtpProfileRadioVaps=fgWcWtpProfileRadioVaps, fgWcStaIpAddress=fgWcStaIpAddress, fgWcApVdom=fgWcApVdom, fgModel=fgModel, fgVpnSslTunnelIndex=fgVpnSslTunnelIndex, fgIntf=fgIntf, fgHaPriority=fgHaPriority, fgAvVirusBlocked=fgAvVirusBlocked, fgWebCacheBypass=fgWebCacheBypass, fgLinkMonitorNumber=fgLinkMonitorNumber, fgIntfVrrpEntGrpId=fgIntfVrrpEntGrpId, fgApIMUpTime=fgApIMUpTime, fgAvNNTPVirusDetected=fgAvNNTPVirusDetected, fgWcWtpSessionRadioOperatingPower=fgWcWtpSessionRadioOperatingPower, fgDeviceObjectGroup=fgDeviceObjectGroup, fgSystemAdvancedObjectGroup=fgSystemAdvancedObjectGroup, fgExplicitProxyScanStatsTable=fgExplicitProxyScanStatsTable, fgWanOptDiskMisses=fgWanOptDiskMisses, fgUsbportProdId=fgUsbportProdId, fgIpSessProto=fgIpSessProto, fgtVM64AWSONDEMAND=fgtVM64AWSONDEMAND, fgVpnDialupGateway=fgVpnDialupGateway, fgHaStatsMasterSerial=fgHaStatsMasterSerial, fgUsbportManufacturer=fgUsbportManufacturer, fgApHTTPReqProcessed=fgApHTTPReqProcessed, fgExplicitProxyFilteredOthScript=fgExplicitProxyFilteredOthScript, fgAppWanOpt=fgAppWanOpt, fgWcWtpProfileRadioAutoTxPowerHigh=fgWcWtpProfileRadioAutoTxPowerHigh, fgAppIMFileTxBlocked=fgAppIMFileTxBlocked, fgAvOversizedBlocked=fgAvOversizedBlocked, fgIntfVlanHbEntIndex=fgIntfVlanHbEntIndex, fgProcessorModuleTypes=fgProcessorModuleTypes, FgWcWlanEncryptionType=FgWcWlanEncryptionType, fgApSMTPConnections=fgApSMTPConnections, fgWcWtpProfileRadioBeaconInterval=fgWcWtpProfileRadioBeaconInterval, fgServerLoadBalanceObjectGroup=fgServerLoadBalanceObjectGroup, fgFmTrapConfChange=fgFmTrapConfChange, fgHaAutoSync=fgHaAutoSync, fgWcWtpProfileRadioChannelWidth=fgWcWtpProfileRadioChannelWidth, fgVpnTunEntVdom=fgVpnTunEntVdom, fgAppSuFileScanned=fgAppSuFileScanned, fgWcTrapObjects=fgWcTrapObjects, fgAppIMStatsEntry=fgAppIMStatsEntry, fgProcessorType=fgProcessorType, fwf81CM=fwf81CM, fgVpn=fgVpn, fgUsbModemVendor=fgUsbModemVendor, fgUsbportVendId=fgUsbportVendId, fgFwPol6ID=fgFwPol6ID, fgWebCacheDiskHits=fgWebCacheDiskHits, FgSessProto=FgSessProto, fgApSMTPSpamDetected=fgApSMTPSpamDetected, fgHaStatsNetUsage=fgHaStatsNetUsage, PYSNMP_MODULE_ID=fnFortiGateMib, fgWanOptHistoryStatsTable=fgWanOptHistoryStatsTable, fgAppProxyPOP3=fgAppProxyPOP3, fgTrapPrefix=fgTrapPrefix, fgt50E=fgt50E, fgWcWlanEntry=fgWcWlanEntry, fgAvIMAPVirusDetected=fgAvIMAPVirusDetected, fgIpsLowSevDetections=fgIpsLowSevDetections, fgTrapPerCpuHigh=fgTrapPerCpuHigh, fgManIfIp=fgManIfIp, fgApSIPUpTime=fgApSIPUpTime, fgIps=fgIps, fgProcessorsObjectGroup=fgProcessorsObjectGroup, FgScanAvDisposition=FgScanAvDisposition, fgProcModMemUsage=fgProcModMemUsage, fgt600D=fgt600D, fgProcModFnXD4=fgProcModFnXD4, fgWanOptStatsEntry=fgWanOptStatsEntry, fgWebCacheObjectGroup=fgWebCacheObjectGroup, fgFmTrapDeployComplete=fgFmTrapDeployComplete, FgWcWtpRadioType=FgWcWtpRadioType, fgWanOptLANBytesOut=fgWanOptLANBytesOut, fgWcWtpProfileCountryString=fgWcWtpProfileCountryString, fgt3700D=fgt3700D, fgIntfVrrpEntVrId=fgIntfVrrpEntVrId, fgSIAdvMemPageCache=fgSIAdvMemPageCache, fgVpnDialupInOctets=fgVpnDialupInOctets, fgApHTTPStatsTable=fgApHTTPStatsTable, fgAppP2PStatsEntry=fgAppP2PStatsEntry, FgWanOptHistPeriods=FgWanOptHistPeriods, fgHaTables=fgHaTables, fgAppVoIP=fgAppVoIP, fgIntfVlanHbEntSerial=fgIntfVlanHbEntSerial, fgExplicitProxyPolicy=fgExplicitProxyPolicy, fgHaSchedule=fgHaSchedule, fgWcWtpProfilePlatform=fgWcWtpProfilePlatform, fgWcWtpSessionRadioStationCount=fgWcWtpSessionRadioStationCount, fgIntfVrrpCount=fgIntfVrrpCount, fgByteCacheRAMLimit=fgByteCacheRAMLimit, fgt200D=fgt200D, fgSysSes6Rate1=fgSysSes6Rate1, fgProcModFnFE8=fgProcModFnFE8, fgWcWtpProfileRadioBand=fgWcWtpProfileRadioBand, fgWcApSerial=fgWcApSerial, fwf51E=fwf51E, fgFwPolID=fgFwPolID, fg900D=fg900D, fgIpsMedSevDetections=fgIpsMedSevDetections, fgIpSessToAddr=fgIpSessToAddr, fgIntfVrrpEntry=fgIntfVrrpEntry, fgApSIPServices=fgApSIPServices, fgt800C=fgt800C, fgIpSessExp=fgIpSessExp, fgNPU=fgNPU, fgMemCacheUsage=fgMemCacheUsage, fgVpnTunEntSelectorDstBeginIp=fgVpnTunEntSelectorDstBeginIp, fgWcInfoWtpCapacity=fgWcInfoWtpCapacity, fgNPUNumber=fgNPUNumber, fgSystemInfo=fgSystemInfo, fgSysMgmtVdom=fgSysMgmtVdom, fgFgWfHTTPSOverridden=fgFgWfHTTPSOverridden, fgProcessorPktRxCount=fgProcessorPktRxCount, fgFwPolStatsTable=fgFwPolStatsTable, fgProcModProcessorCount=fgProcModProcessorCount, fgWcStaMacAddress=fgWcStaMacAddress, fgAvOversizedDetected=fgAvOversizedDetected, fgVpnSslState=fgVpnSslState, fgWcWtpConfigRadioApScan=fgWcWtpConfigRadioApScan, fgWcWlanRadiusServer=fgWcWlanRadiusServer, fgWcWtpSessionVapByteRxCount=fgWcWtpSessionVapByteRxCount, fgNPUInfo=fgNPUInfo, fgApIMAPStatsTable=fgApIMAPStatsTable, fgUsbportEntIndex=fgUsbportEntIndex, fgWebfilterStatsTable=fgWebfilterStatsTable, fgWcWtpSessionWtpLocalIpAddress=fgWcWtpSessionWtpLocalIpAddress, fgt3000D=fgt3000D, fgIntfTable=fgIntfTable, fgAvStatsEntry=fgAvStatsEntry, fgApIMMemUsage=fgApIMMemUsage, fgAppSuNumber=fgAppSuNumber, fgSysSesRate10=fgSysSesRate10, fgExplicitProxyObjectGroup=fgExplicitProxyObjectGroup, fgVpnTunEntLifeSecs=fgVpnTunEntLifeSecs, fgAppIMConnBlocked=fgAppIMConnBlocked, fgHaTrapObjects=fgHaTrapObjects, fgVpnDialupDstAddr=fgVpnDialupDstAddr, fgWcWtpSessionWtpLocalIpAddressType=fgWcWtpSessionWtpLocalIpAddressType, fgDeviceTrapObjects=fgDeviceTrapObjects, fgTrapDeviceNew=fgTrapDeviceNew, fgWcWtpTables=fgWcWtpTables, fgProcessorFnNP4=fgProcessorFnNP4, fgWcWtpSessionWtpBaseMacAddress=fgWcWtpSessionWtpBaseMacAddress, fgAvSMTPVirusDetected=fgAvSMTPVirusDetected, fgWcWtpConfigRadioEnable=fgWcWtpConfigRadioEnable, fgApIMReqProcessed=fgApIMReqProcessed, fgAppP2P=fgAppP2P, fgVdTable=fgVdTable, fgUsbModemSimState=fgUsbModemSimState, fgProcModSessionCount=fgProcModSessionCount, fgTrapHaStateChange=fgTrapHaStateChange, fgAdminEntry=fgAdminEntry, fgWcWtpProfileRadioProfileName=fgWcWtpProfileRadioProfileName, fgt3700DX=fgt3700DX, fgWcWtpSessionRadioEntry=fgWcWtpSessionRadioEntry, fgWcObjectGroup=fgWcObjectGroup, fwf92D=fwf92D, fgProcessorTable=fgProcessorTable, fgVpnDialupSrcEnd=fgVpnDialupSrcEnd, fgUsbportTable=fgUsbportTable, fgt3800D=fgt3800D, fgProcModIntegrated=fgProcModIntegrated)
