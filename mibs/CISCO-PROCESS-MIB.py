...
# ASN.1 source file://mibs/CISCO-PROCESS-MIB.mib
...
mibBuilder.exportSymbols("CISCO-PROCESS-MIB", cpmCPUMemoryHCLowest=cpmCPUMemoryHCLowest, cpmThreadHCStackSize=cpmThreadHCStackSize, cpmProcessEntry=cpmProcessEntry, cpmPosixProcessGroup=cpmPosixProcessGroup, cpmProcExtInvokedRev=cpmProcExtInvokedRev, cpmCPUHistoryTotalUtil=cpmCPUHistoryTotalUtil, cpmCPURisingThresholdPeriod=cpmCPURisingThresholdPeriod, cpmCoreGroup=cpmCoreGroup, cpmThread=cpmThread, cpmProcessTextSegmentSizeOvrflw=cpmProcessTextSegmentSizeOvrflw, cpmThreadEntry=cpmThreadEntry, cpmVirtualProcessHCMemFreed=cpmVirtualProcessHCMemFreed, cpmCPUThresholdGroup=cpmCPUThresholdGroup, cpmProcessExtRevTable=cpmProcessExtRevTable, cpmCPU=cpmCPU, cpmProcExtUtil1Min=cpmProcExtUtil1Min, cpmCPUTotal5min=cpmCPUTotal5min, cpmVirtualProcessGroup=cpmVirtualProcessGroup, cpmProcessLastRestartUser=cpmProcessLastRestartUser, cpmCoreLoadAvg1min=cpmCoreLoadAvg1min, cpmCPULoadAvg15min=cpmCPULoadAvg15min, cpmVirtualProcessName=cpmVirtualProcessName, ciscoProcessMIB=ciscoProcessMIB, cpmProcessType=cpmProcessType, cpmProcExtMemFreedRevOvrflw=cpmProcExtMemFreedRevOvrflw, cpmProcessExtRevEntry=cpmProcessExtRevEntry, cpmThreadCpuUtilization=cpmThreadCpuUtilization, cProcessMIBComplianceRev3=cProcessMIBComplianceRev3, cpmCPUTotal1minRev=cpmCPUTotal1minRev, cpmVirtualProcessInvokeCount=cpmVirtualProcessInvokeCount, cpmCPUHistoryInterruptUtil=cpmCPUHistoryInterruptUtil, cpmCoreLoadAvg5min=cpmCoreLoadAvg5min, cpmCPUHistoryCreatedTime=cpmCPUHistoryCreatedTime, cpmThreadStackSizeOvrflw=cpmThreadStackSizeOvrflw, cpmProcExtPriorityRev=cpmProcExtPriorityRev, CPULoadAverage=CPULoadAverage, cpmProcExtPriority=cpmProcExtPriority, cpmCPURisingThresholdValue=cpmCPURisingThresholdValue, cpmCPUTotal5secRev=cpmCPUTotal5secRev, cpmCPUHistoryThreshold=cpmCPUHistoryThreshold, cpmCPUTotalGroupRev=cpmCPUTotalGroupRev, cpmCPUMemoryFreeOvrflw=cpmCPUMemoryFreeOvrflw, cpmCore1min=cpmCore1min, cpmCPUMemoryCommittedOvrflw=cpmCPUMemoryCommittedOvrflw, cpmCPUTotal1min=cpmCPUTotal1min, cpmVirtualProcessOverflowGroup=cpmVirtualProcessOverflowGroup, cpmCPUPosixMemoryGroup=cpmCPUPosixMemoryGroup, cpmCPUMemoryFree=cpmCPUMemoryFree, cpmProcExtRuntimeRev=cpmProcExtRuntimeRev, cpmCPUMemoryHCCommitted=cpmCPUMemoryHCCommitted, cpmProcessTextSegmentSize=cpmProcessTextSegmentSize, cpmCPUTotalMonIntervalValue=cpmCPUTotalMonIntervalValue, cpmProcessRespawnCount=cpmProcessRespawnCount, cpmCore5sec=cpmCore5sec, cpmProcessGroup=cpmProcessGroup, cpmVirtualProcessEntry=cpmVirtualProcessEntry, cpmProcExtMemAllocatedRev=cpmProcExtMemAllocatedRev, cpmThreadPriority=cpmThreadPriority, cpmCPUHistoryGroup=cpmCPUHistoryGroup, cpmVirtualProcess=cpmVirtualProcess, cpmCPUTotalOverflowGroup=cpmCPUTotalOverflowGroup, cpmProcExtUtil5SecRev=cpmProcExtUtil5SecRev, cpmCPUInterruptMonIntervalValue=cpmCPUInterruptMonIntervalValue, cpmCoreIndex=cpmCoreIndex, cProcessMIBComplianceRev5=cProcessMIBComplianceRev5, cpmCPULoadAvg1min=cpmCPULoadAvg1min, cpmCPUTotalMemoryCommitGroup=cpmCPUTotalMemoryCommitGroup, cpmProcExtRuntime=cpmProcExtRuntime, cpmThreadStackSize=cpmThreadStackSize, cpmCPUFallingThresholdValue=cpmCPUFallingThresholdValue, cpmVirtualProcessRuntime=cpmVirtualProcessRuntime, cpmVirtualProcessUtil5Sec=cpmVirtualProcessUtil5Sec, ciscoProcessMIBNotifs=ciscoProcessMIBNotifs, cpmProcessDataSegmentSizeOvrflw=cpmProcessDataSegmentSizeOvrflw, cpmVirtualProcessMemAllocatedOvrflw=cpmVirtualProcessMemAllocatedOvrflw, cpmCPUTotalPhysicalIndex=cpmCPUTotalPhysicalIndex, cpmProcessExtGroupRev=cpmProcessExtGroupRev, cpmProcessRespawnAfterLastPatch=cpmProcessRespawnAfterLastPatch, cpmCoreEntry=cpmCoreEntry, cpmProcessAverageUSecs=cpmProcessAverageUSecs, cpmCPUMemoryLowestOvrflw=cpmCPUMemoryLowestOvrflw, cpmCPUHistoryEntry=cpmCPUHistoryEntry, cpmCPUThresholdTable=cpmCPUThresholdTable, cpmCPUTotalGroupRev1=cpmCPUTotalGroupRev1, cpmCPUProcessHistoryTable=cpmCPUProcessHistoryTable, cpmCPUThresholdEntryStatus=cpmCPUThresholdEntryStatus, cpmVirtualProcessMemAllocated=cpmVirtualProcessMemAllocated, cpmCPUTotal5minRev=cpmCPUTotal5minRev, cProcessMIBCompliance=cProcessMIBCompliance, cpmProcExtInvoked=cpmProcExtInvoked, cpmProcessExtEntry=cpmProcessExtEntry, cpmProcessHCTextSegmentSize=cpmProcessHCTextSegmentSize, cpmCPUMemoryHCUsed=cpmCPUMemoryHCUsed, cpmCPUMemoryCommitted=cpmCPUMemoryCommitted, cpmProcessDynamicMemorySizeOvrflw=cpmProcessDynamicMemorySizeOvrflw, cpmCPUMemoryUsed=cpmCPUMemoryUsed, cpmProcessHCDataSegmentSize=cpmProcessHCDataSegmentSize, cpmVirtualProcessTable=cpmVirtualProcessTable, cpmProcessExtGroup=cpmProcessExtGroup, cpmThreadTable=cpmThreadTable, cpmCPUHistoryProcUtil=cpmCPUHistoryProcUtil, cpmProcessDataSegmentSize=cpmProcessDataSegmentSize, cpmCPULoadAvgGroup=cpmCPULoadAvgGroup, cpmProcessHCStackSize=cpmProcessHCStackSize, cpmThreadName=cpmThreadName, cpmThreadGroup=cpmThreadGroup, cpmProcessMemoryCore=cpmProcessMemoryCore, cpmCPUTotal5sec=cpmCPUTotal5sec, cpmCPUTotalGroup=cpmCPUTotalGroup, cProcessMIBComplianceRev=cProcessMIBComplianceRev, cpmCPUHistoryTable=cpmCPUHistoryTable, cpmCPUThresholdEntry=cpmCPUThresholdEntry, cpmCPUThresholdClass=cpmCPUThresholdClass, cpmCPUHistoryProcName=cpmCPUHistoryProcName, cpmCPUMemoryKernelReserved=cpmCPUMemoryKernelReserved, cpmCPUMemoryUsedOvrflw=cpmCPUMemoryUsedOvrflw, cpmCPUMemoryKernelReservedOvrflw=cpmCPUMemoryKernelReservedOvrflw, cpmProcExtUtil5Sec=cpmProcExtUtil5Sec, cpmProcessGroupRev=cpmProcessGroupRev, cpmCPUFallingThresholdPeriod=cpmCPUFallingThresholdPeriod, cpmVirtualProcessMemFreedOvrflw=cpmVirtualProcessMemFreedOvrflw, cpmCPUFallingThreshold=cpmCPUFallingThreshold, cpmGroups=cpmGroups, cpmCPURisingThreshold=cpmCPURisingThreshold, cpmVirtualProcessUtil1Min=cpmVirtualProcessUtil1Min, cpmProcessExtRevOverflowGroup=cpmProcessExtRevOverflowGroup, cpmProcExtMemAllocatedRevOvrflw=cpmProcExtMemAllocatedRevOvrflw, cpmCore5min=cpmCore5min, cpmProcessDynamicMemorySize=cpmProcessDynamicMemorySize, cpmCPUMonInterval=cpmCPUMonInterval, cpmCorePhysicalIndex=cpmCorePhysicalIndex, cpmVirtualProcessMemFreed=cpmVirtualProcessMemFreed, cpmCPUHistoryProcId=cpmCPUHistoryProcId, cpmProcExtUtil5MinRev=cpmProcExtUtil5MinRev, cpmCPUHistoryReportSize=cpmCPUHistoryReportSize, cpmVirtualProcessUtil5Min=cpmVirtualProcessUtil5Min, cpmThreadOverflowGroup=cpmThreadOverflowGroup, cpmCPULoadAvg5min=cpmCPULoadAvg5min, ciscoProcessMIBNotifPrefix=ciscoProcessMIBNotifPrefix, cpmProcessHCDynamicMemorySize=cpmProcessHCDynamicMemorySize, cpmProcExtHCMemAllocatedRev=cpmProcExtHCMemAllocatedRev, cProcessMIBComplianceRev2=cProcessMIBComplianceRev2, ciscoProcessMIBObjects=ciscoProcessMIBObjects, cpmCoreTable=cpmCoreTable, cpmProcExtMemFreed=cpmProcExtMemFreed, cpmCPUThresholdNotificationGroup=cpmCPUThresholdNotificationGroup, cpmCPUTotalEntry=cpmCPUTotalEntry, cpmCPUProcessHistoryIndex=cpmCPUProcessHistoryIndex, cpmProcExtUtil1MinRev=cpmProcExtUtil1MinRev, cpmProcessExtTable=cpmProcessExtTable, cpmProcessTimeCreated=cpmProcessTimeCreated, cpmVirtualProcessHCGroup=cpmVirtualProcessHCGroup, cProcessMIBComplianceRev1=cProcessMIBComplianceRev1, cpmProcessExtRevHCGroup=cpmProcessExtRevHCGroup, cpmProcessStackSize=cpmProcessStackSize, cpmCPUHistoryReportId=cpmCPUHistoryReportId, cpmProcExtMemFreedRev=cpmProcExtMemFreedRev, cpmProcess=cpmProcess, cpmProcessName=cpmProcessName, cpmProcExtUtil5Min=cpmProcExtUtil5Min, cpmCoreLoadAvg15min=cpmCoreLoadAvg15min, cpmProcessStackSizeOvrflw=cpmProcessStackSizeOvrflw, cpmThreadHCGroup=cpmThreadHCGroup, cpmCPUMemoryHCKernelReserved=cpmCPUMemoryHCKernelReserved, cpmProcExtMemAllocated=cpmProcExtMemAllocated, cpmProcessTable=cpmProcessTable, cpmThreadState=cpmThreadState, cpmCPUTotalIndex=cpmCPUTotalIndex, cpmCPUTotalHCGroup=cpmCPUTotalHCGroup, cpmThreadBlockingProcess=cpmThreadBlockingProcess, PYSNMP_MODULE_ID=ciscoProcessMIB, cpmCompliances=cpmCompliances, cpmCPUProcessHistoryEntry=cpmCPUProcessHistoryEntry, cpmProcessPID=cpmProcessPID, cpmThreadID=cpmThreadID, ciscoProcessMIBConformance=ciscoProcessMIBConformance, cpmCPUMemoryLowest=cpmCPUMemoryLowest, cpmVirtualProcessHCMemAllocated=cpmVirtualProcessHCMemAllocated, cpmCPUHistory=cpmCPUHistory, cProcessMIBComplianceRev4=cProcessMIBComplianceRev4, cpmVirtualProcessID=cpmVirtualProcessID, cpmProcessuSecs=cpmProcessuSecs, cpmCPUHistorySize=cpmCPUHistorySize, cpmProcessRespawn=cpmProcessRespawn, cpmCPUHistoryProcCreated=cpmCPUHistoryProcCreated, cpmCPUTotalTable=cpmCPUTotalTable, cpmCPUMemoryHCFree=cpmCPUMemoryHCFree, cpmProcExtHCMemFreedRev=cpmProcExtHCMemFreedRev)
