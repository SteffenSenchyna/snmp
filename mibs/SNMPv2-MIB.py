...
snmpModules, Bits, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Counter64, Gauge32, MibIdentifier, Counter32, Integer32, IpAddress, TimeTicks, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Bits", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Counter64", "Gauge32", "MibIdentifier", "Counter32", "Integer32", "IpAddress", "TimeTicks", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpCommunityGroup1=snmpCommunityGroup1, system=system, snmpInSetRequests=snmpInSetRequests, snmpMIB=snmpMIB, snmpInGetResponses=snmpInGetResponses, snmpOutGetNexts=snmpOutGetNexts, sysORLastChange=sysORLastChange, snmpTrapOID=snmpTrapOID, snmpInASNParseErrs=snmpInASNParseErrs, PYSNMP_MODULE_ID=snmpMIB, warmStart=warmStart, sysOREntry=sysOREntry, sysUpTime=sysUpTime, snmpOutTooBigs=snmpOutTooBigs, sysORID=sysORID, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpInNoSuchNames=snmpInNoSuchNames, sysLocation=sysLocation, snmpMIBGroups=snmpMIBGroups, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpSilentDrops=snmpSilentDrops, snmpInGetNexts=snmpInGetNexts, snmpProxyDrops=snmpProxyDrops, snmpInGenErrs=snmpInGenErrs, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpObsoleteGroup=snmpObsoleteGroup, snmpSetGroup=snmpSetGroup, snmpInTooBigs=snmpInTooBigs, snmpInGetRequests=snmpInGetRequests, sysORDescr=sysORDescr, sysContact=sysContact, snmpOutPkts=snmpOutPkts, snmpInBadCommunityNames=snmpInBadCommunityNames, snmp=snmp, sysORUpTime=sysORUpTime, sysDescr=sysDescr, snmpSet=snmpSet, systemGroup=systemGroup, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInReadOnlys=snmpInReadOnlys, snmpInTotalSetVars=snmpInTotalSetVars, snmpMIBConformance=snmpMIBConformance, snmpInTraps=snmpInTraps, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, snmpOutSetRequests=snmpOutSetRequests, snmpGroup=snmpGroup, sysORIndex=sysORIndex, snmpEnableAuthenTraps=snmpEnableAuthenTraps, sysName=sysName, coldStart=coldStart, snmpSetSerialNo=snmpSetSerialNo, snmpOutGetResponses=snmpOutGetResponses, snmpTrap=snmpTrap, snmpTraps=snmpTraps, snmpInBadVersions=snmpInBadVersions, snmpInBadValues=snmpInBadValues, snmpOutGetRequests=snmpOutGetRequests, snmpNotificationGroup=snmpNotificationGroup, snmpOutTraps=snmpOutTraps, sysObjectID=sysObjectID, authenticationFailure=authenticationFailure, snmpTrapEnterprise=snmpTrapEnterprise, snmpMIBCompliances=snmpMIBCompliances, snmpOutBadValues=snmpOutBadValues, snmpOutGenErrs=snmpOutGenErrs, snmpBasicCompliance=snmpBasicCompliance, snmpMIBObjects=snmpMIBObjects, sysORTable=sysORTable, sysServices=sysServices, snmpInTotalReqVars=snmpInTotalReqVars, snmpInPkts=snmpInPkts)
