...
# ASN.1 source file://mibs/CISCO-TC.mib
# Produced by pysmi-0.3.4 at Mon Apr  3 17:13:28 2023
...
TimeTicks, ModuleIdentity, Gauge32, Counter64, Bits, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, IpAddress, Unsigned32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter64", "Bits", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "IpAddress", "Unsigned32", "Integer32", "iso")
...
mibBuilder.exportSymbols("CISCO-TC", CiscoPortListRange=CiscoPortListRange, CiscoPort=CiscoPort, BulkConfigResult=BulkConfigResult, CiscoMilliSeconds=CiscoMilliSeconds, CiscoBridgeDomain=CiscoBridgeDomain, Layer2Cos=Layer2Cos, CiscoHTTPResponseStatusCode=CiscoHTTPResponseStatusCode, EntPhysicalIndexOrZero=EntPhysicalIndexOrZero, CiscoURLStringOrEmpty=CiscoURLStringOrEmpty, CiscoRowOperStatus=CiscoRowOperStatus, CiscoAbsZeroBasedCounter32=CiscoAbsZeroBasedCounter32, Unsigned64=Unsigned64, CiscoPortList=CiscoPortList, CountryCodeITU=CountryCodeITU, CiscoNetworkAddress=CiscoNetworkAddress, CiscoInetAddressMask=CiscoInetAddressMask, TimeIntervalSec=TimeIntervalSec, CiscoCosList=CiscoCosList, CiscoIpProtocol=CiscoIpProtocol, ListIndexOrZero=ListIndexOrZero, PerfHighIntervalCount=PerfHighIntervalCount, CiscoAlarmSeverity=CiscoAlarmSeverity, CiscoPbbServiceIdentifier=CiscoPbbServiceIdentifier, MicroSeconds=MicroSeconds, CiscoURLString=CiscoURLString, TimeIntervalMin=TimeIntervalMin, Cisco2KVlanList=Cisco2KVlanList, CiscoVlanList=CiscoVlanList, CiscoInterfaceIndexList=CiscoInterfaceIndexList, PYSNMP_MODULE_ID=ciscoTextualConventions, CiscoNetworkProtocol=CiscoNetworkProtocol, ListIndex=ListIndex, IfOperStatusReason=IfOperStatusReason, InterfaceIndexOrZero=InterfaceIndexOrZero, CiscoAbsZeroBasedCounter64=CiscoAbsZeroBasedCounter64, CiscoSnapShotAbsCounter32=CiscoSnapShotAbsCounter32, CvE164Address=CvE164Address, CiscoEntityIndexList=CiscoEntityIndexList, CiscoVlanIndex=CiscoVlanIndex, CiscoLocationClass=CiscoLocationClass, SAPType=SAPType, CountryCode=CountryCode, CiscoVrfName=CiscoVrfName, ConfigIterator=ConfigIterator, EntLogicalIndexOrZero=EntLogicalIndexOrZero, CiscoLocationSpecifier=CiscoLocationSpecifier, ciscoTextualConventions=ciscoTextualConventions)
